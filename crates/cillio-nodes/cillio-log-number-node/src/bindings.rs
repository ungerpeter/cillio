...
pub unsafe fn _export_run_cabi<T: Guest>(arg0: f32) {
...
macro_rules! __export_world_node_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "run"]
    unsafe extern "C" fn export_run(arg0: f32,) {
...
@\x01\x06numberv\x01\0\x04\0\x03run\x01\0\x04\x01\x1bcillio-node:log-number/node\
\x04\0\x0b\x0a\x01\0\x04node\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
